  ...
  return (
    <div className="flex justify-center mb-[80px]">
      <div className="max-w-[1440px] w-full">
        <div className="flex flex-col items-center mb-[40px] mt-[40px] md:mt-[80px]">
          <h1 className="font-bold text-[42px] md:text-[48px] text-[#001931] text-center">
            Our All Applications
          </h1>
          <p className="mt-[16px] text-[#627382] text-center">
            Explore All Apps on the Market developed by us. We code for Millions
          </p>
        </div>
        <div>
          <div className="text-black flex flex-col-reverse sm:flex-row justify-between mb-[16px] p-[10px]">
            <h1 className="font-semibold text-[20px] md:text-[24px] mt-[10px] sm:mt-[0px]">
